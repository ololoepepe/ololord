...
OLOLORD_EXPORT bool cachePost(const QString &boardName, quint64 postNumber, Content::BaseBoard::Post *post);
...
OLOLORD_EXPORT Content::BaseBoard::Post *post(const QString &boardName, quint64 postNumber);
