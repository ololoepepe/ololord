...
const int defaultCustomHomePageContentsCacheSize = 10 * BeQt::Megabyte;
...
OLOLORD_EXPORT bool cacheCustomHomePageContent(const QLocale &l, QString *content);
OLOLORD_EXPORT bool cacheDynamicFile(const QString &path, Tools::StaticFile *file);
...
OLOLORD_EXPORT bool cacheStaticFile(const QString &path, Tools::StaticFile *file);
...
OLOLORD_EXPORT void clearCustomHomePageContent();
...
OLOLORD_EXPORT Tools::StaticFile *dynamicFile(const QString &path);
...
OLOLORD_EXPORT void setCustomHomePageContentMaxCacheSize(int size);
...
OLOLORD_EXPORT Tools::StaticFile *staticFile(const QString &path);
